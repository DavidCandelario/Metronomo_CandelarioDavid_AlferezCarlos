...
from Ejecutar import reproductor
...
def main():
    ...
    cuadro= Label(frame1, fg="black", padx=15, pady=10, text="Ingrese el nombre del archivo sin la extension:")
    ...
    grabarButton1 = Button(frame6, padx=30, pady=2, text="Grabar", command=lambda:(playM(), activasms1()))
